...
# ESTA LÍNEA ES LA CLAVE: Desactiva el Realtime que rompe Vercel
supabase = create_client(URL, KEY, options={"realtime_options": {"timeout": 1}})
...
def main(page: ft.Page):
    ...
    def cargar_mensajes(e=None):
        try:
            # Consulta simple de datos - Esto NO usa WebSockets
